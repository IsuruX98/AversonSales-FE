...
const Navbar = () => {
    ...
    return (
        ...
        >
            ...
            <div className="cursor-pointer md:hidden">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none">
                    <g clip-path="url(#clip0_762_142)">
                        <path d="M28.0957 41.3722L32.0472 43.7513L35.9476 41.3455L32.0481 39.2935L28.0957 41.3722Z"
                              fill="white"/>
                        ...
                        <path
                            ...
                            fill="white"/>
                        <path d="M37.1071 40.6286L46.4216 34.8807L45.0308 29.3115L36.3438 36.171L37.1071 40.6286Z"
                              fill="white"/>
                        <path
                        ...
                        <path
                            ...
                            fill="white"/>
                        <path d="M16.7119 34.3554L18.0348 28.7114H0C0 28.7114 2.16062 34.3554 6.39406 34.3554H16.7119Z"
                              fill="white"/>
                        <path
            ...
            <div
                className={`items-center hidden space-x-12 md:flex ${
            ...
            <div className={`items-center hidden space-x-12 md:flex ${
                ...
                <button
                    className={`flex items-center justify-center gap-2 px-8 py-4 bg-transparent border-2 ${isAtTop ? "border-white" : "border-black"} rounded-full`}>
                    Talk to an Expert
                </button>
            </div>
            ...
            <div
                onClick={handleNav}
                className={`flex items-center justify-center md:hidden ${isAtTop ? "text-white" : "text-black"}`}
            >
